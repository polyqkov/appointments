...
abstract class $ServiceModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String name, double price, Currencies currency});
}
...
class _$ServiceModelImpl implements _ServiceModel {
  ...
  @override
  String toString() {
    return 'ServiceModel(id: $id, name: $name, price: $price, currency: $currency)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, price, currency);
...
abstract class _ServiceModel implements ServiceModel {
  const factory _ServiceModel(
      ...
      required final Currencies currency}) = _$ServiceModelImpl;
